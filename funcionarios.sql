/*Exercício feito utilizando uma tabela que está disponível online no curso de Banco de Dados Relacionais da Udemy - Neste exercício, foi colocado em pratica o uso do OR e WHERE.

Os exercícios estão logo após os inserts.
*/
...
/*Traga os funcionários que trabalham no departamento de filmes ou no departamento de roupas*/
select nome, departamento, cargo from funcionarios
where departamento = 'Filmes'
or departamento = 'Roupas';

/*O gestor de marketing pediu a lista dos funcionários que trabalham no departamento de filmes ou no departamento lar. Ele necessita enviar um email para os colaboradores desses dois setores*/
select nome, email, departamento from funcionarios
where departamento = 'Filmes'
or departamento = 'Lar';

/*Traga os funcionários do sexo masculino ou os funcionários que trabalham no departamento de Jardim
*/
